...
The PoC now prefers a tiny C demo target when `cc` is available and will refuse restore if the original PID is still alive unless you explicitly allow the script to stop it.
